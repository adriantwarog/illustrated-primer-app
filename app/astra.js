...
async function main(inputValue, inputType = 'chat', outputType = 'chat', stream = true) {
    const flowIdOrName = 'ed4c4dd1-ee4b-4f85-b6c8-dda030964e16';
    const langflowId = '298786cf-f3a2-44ea-8634-4a2eafce5bb8';
